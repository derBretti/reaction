...
export default function summary(fulfillmentGroup) {
  ...
  const { currencyCode, discounts, effectiveTaxRate, netAmount, shipping, subtotal, surcharges, taxableAmount, taxes, total } = invoice;
  ...
  return {
    ...
    netTotal: { amount: netAmount, currencyCode },
